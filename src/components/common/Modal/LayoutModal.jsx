...
const LayoutModal = ({ show, onHide,items }) => {
    return (
      // <DynamicModalBox
      //   show={show}
      //   onHide={onHide}
      ...
      //   ))}
      //    {/* {items.map((item, i) => (
      //   <div className="row justify-content-between align-items-center mt-2" key={i}>
      //     <div className="col-md-6">
      //       <button type="submit" className="btn btn-md">
      //         <svg
      //           xmlns="http://www.w3.org/2000/svg"
      ...
      //         </svg>
      //       </button>
      //       <label>{item}</label> {/* Dynamically display the item name */}
      //     {/* </div>
      //     <div className="col-md-4">
      //       <div className="form-check form-switch mt-1">
      //         <input
    ...
    items.map((item, i) => (
      ...
      >
        <div className="col-md-6" style={{ display: 'flex', alignItems: 'center' }}>
          <button type="submit" className="btn btn-md" style={{ marginRight: '10px' }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
              height="22"
          ...
          <label style={{ wordWrap: 'break-word', marginLeft: '10px' }}>{item}</label> {/* Dynamically display the item name */}
        </div>
        <div className="col-md-4" style={{ textAlign: 'right' }}>
          <div className="form-check form-switch mt-1" style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <input
              className="form-check-input"
              type="checkbox"
              role="switch"
