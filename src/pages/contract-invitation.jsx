...
export default function ContractInvitation() {
  ...
  const fetchEventsData = async () => {
    try {
      const response = await fetch(
        `${baseURL}/rfq/events/eois?token=bfa5004e7b0175622be8f7e69b37d01290b737f82e078414`
      );
  ...
  const handleSearchSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(
        `${baseURL}/rfq/events?token=bfa5004e7b0175622be8f7e69b37d01290b737f82e078414&q[event_title_or_event_no_or_status_or_created_at_or_event_schedule_start_time_or_event_schedule_end_time_cont]=${searchTerm}`
      );
  ...
  const fetchSuggestions = async (query) => {
    ...
    try {
      const response = await axios.get(
        `${baseURL}/rfq/events?token=bfa5004e7b0175622be8f7e69b37d01290b737f82e078414&q[event_title_or_event_no_or_status_or_created_at_or_event_schedule_start_time_or_event_schedule_end_time_cont]=${query}`
      );
      setSuggestions(response.data.events);
