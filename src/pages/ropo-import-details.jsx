                        ...
                        <th>{ropoData?.po_currency || "USD"}</th>
                         ...
                         <tbody>
                           ...
                           <tr>
                            ...
                            // )}
                             value={(() => {
    const usdValue = parseFloat(taxRateData[tableId]?.afterDiscountValue || 0);
    return isNaN(usdValue) ? "0.00" : usdValue.toFixed(2);
                                ...
                                placeholder="Tax Amount (INR)"
                                 ...
                                 <td>
                                   <input
                                     ...
                                     className="form-control"
                                     value={(() => {
                                  const usd = parseFloat(item.amount || 0);
                                  return isNaN(usd) ? "0.00" : usd.toFixed(2);
                                     })()}
                                     readOnly
                                     disabled={true}
                          ...
                          <span>-</span>
                           ...
                           <tr>
                            ...
                            // )}
                            value={(() => {
      const usdValue = parseFloat(taxRateData[tableId]?.netCost || 0);
      return isNaN(usdValue) ? "0.00" : usdValue.toFixed(2);
    })()}
                                 readOnly
                                 disabled={true}
