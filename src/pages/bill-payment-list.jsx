...
const BillPaymentList = () => {
  ...
  <div className="module-data-section p-4">
    <a href="">Home &gt; Billing &gt; MOR &gt; Bill Payment</a>
    <h5 className="mt-4">Bill Payment</h5>
        ...
        <div className="row separteinto5 justify-content-start">
          ...
          <div className="col-md-2 text-center">
            <div className="content-box tab-button" data-tab="draft">
              <h4 className="content-box-title">Submit</h4>
          ...
          <div className="col-md-2 text-center">
            <div className="content-box tab-button" data-tab="self-overdue">
              <h4 className="content-box-title">Proceed</h4>
              <p className="content-box-sub">2</p>
            </div>
          </div>
          <div className="col-md-2 text-center">
          ...
          <div className="col-md-2 text-center mt-2">
            <div className="content-box tab-button" data-tab="self-overdue">
              <h4 className="content-box-title">Paid</h4>
              <p className="content-box-sub">2</p>
            </div>
          </div>
          <div className="col-md-2 text-center mt-2">
            <div className="content-box tab-button" data-tab="self-overdue">
              <h4 className="content-box-title">Partly Paid</h4>
              <p className="content-box-sub">2</p>
            </div>
          </div>
          <div className="col-md-2 text-center mt-2">
            <div className="content-box tab-button" data-tab="self-overdue">
              <h4 className="content-box-title">Adjusted</h4>
              <p className="content-box-sub">2</p>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-8 card mx-3">
            <div className="card-header2">
              <h3 className="card-title2">
                <div className="form-group form-control">Applied Fliter</div>
              </h3>
            </div>
            <div className="card-body">
              <div className="row align-items-center">
