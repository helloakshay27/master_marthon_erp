...
const TestTable = () => {
    ...
    const allColumns = [
        ...
        //       <input
        //         type="checkbox"
        //         // Add logic here if you want "select all" functionality
        //         disabled
        //       />
        //     ),
        //     renderCell: (params) => (
        //       <input
        //         type="checkbox"
        //         checked={selectedBoqDetails.includes(params.row.id)}
        ...
        { field: "credit_note_amount", headerName: "Credit Note Ammount", width: 150 },
