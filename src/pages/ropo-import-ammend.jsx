  ...
  const populateOtherSections = (data) => {
    ...
    if (data.terms_and_conditions) {
      ...
      setSupplierAdvancePercentage(
        terms.supplier_advance_percentage?.toString() || ""
      );
    ...
    try {
      ...
      const payload = {
        purchase_order: {
          ...
          supplier_advance_percentage: parseFloat(
            supplierAdvancePercentage || 0
          ),
                                        ...
                                        <tr key={`consolidated-${index}`}>
                                          ...
                                          <td style={{ width: "180px" }}>
                                            <SingleSelector
                                              ...
                                              placeholder="Select Service Provider"
                                               isDisabled={true} // Add this line to disable the selector
  disabled={true} // Add this as backup in case isDisabled doesn't work
                                            />
                                          </td>
