...
export default function CreateEventService() {
    ...
    const handleQuestionChange = (qIdx, field, value) => {
        ...
        console.log("onchange", qIdx, field, value, questions);
    };
            ...
            event: {
                ...
                event_materials_attributes: materialFormData.map((material) => {
                    ...
                    return {
                        ...
                        pms_brand: material.brand_id || material.pms_brand_id || null,
                        pms_colour: material.colour_id || material.pms_colour_id || null,
                        generic_info_id: material.generic_info_id || null,
                        pms_brand_id: material.pms_brand_id || material.brand_id || null,
                        pms_colour_id: material.pms_colour_id || material.colour_id || null,
                                                                        ...
                                                                        setQuestions(prev =>
                                                                            prev.map((q, idx) =>
                                                                                idx === qIdx
                                                                                    ? {
                                                                                        ...q,
                                                                                        subCategoryId: opt ? opt : null,
                                                                                        subCategoryName: subCategories.find((cat) => cat.value == opt)?.label || "",
                                                                                    }
                                                                                    : q
                                                                            )
                                                                        );
