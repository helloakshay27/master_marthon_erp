...
const formatDateTime = (dateString) => {
  ...
  const handleUpdatePurchaseOrder = async () => {
    try {
      ...
      console.log(
        "API URL:",
        `${baseURL}purchase_orders/${id}.json?token=${token}&amend=true`
      );
      ...
      >
                          ...
                          <tr key={`${rowIndex}-${item.id}`}>
                            ...
                            <td>
                              <select
                                ...
                                disabled={(materialTaxPercentages[item.id] || []).length === 0 || !taxRateData[tableId]?.isedit}
                              >
        ...
        <Modal.Footer className="justify-content-center">
          ...
          <button
            ...
            className="purple-btn2"
            style={{ display: taxRateData[tableId]?.isedit ? "inline-block" : "none" }}
          >
            Save Changes
          </button>
        </Modal.Footer>
