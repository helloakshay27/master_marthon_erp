...
const EstimationComparisionList = () => {
                                                                ...
                                                                <tr key={`${companyIndex}-${projectIndex}-${siteIndex}-${wingIndex}`}>
                                                                    ...
                                                                    {wingIndex === 0 && siteIndex === 0 ? (
                                                                        <td className="text-start">
                                                                            {project.budget_id ? (
                                                                                <a href={`/estimation-comparision/${project.budget_id}?token=${token}`}
                                                                    ...
                                                                    {wingIndex === 0 ? (
                                                                        <td className="text-start">
                                                                            {site.budget_id ? (
                                                                                <a href={`/estimation-comparision/${site.budget_id}?token=${token}`}
...
export default EstimationComparisionList;
