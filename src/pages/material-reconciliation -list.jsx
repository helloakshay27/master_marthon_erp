              ...
              <div className="row separteinto7 justify-content-center">
                <div className="col-md-2 text-center">
                  ...
                  >
                    ...
                    <p className="content-box-sub">{data?.status_counts?.total}</p>
                  </div>
                </div>
                <div className="col-md-2 text-center">
                  <div className="content-box tab-button" data-tab="draft">
                    <h4 className="content-box-title fw-semibold">Draft</h4>
                    <p className="content-box-sub">{data?.status_counts?.draft}</p>
                  </div>
                </div>
                <div className="col-md-2 text-center">
                  <div
                  ...
                  >
                    ...
                    <p className="content-box-sub">{data?.status_counts?.approved}</p>
                  </div>
                </div>
                <div className="col-md-2 text-center">
                  <div
                  ...
                  >
                    ...
                    <p className="content-box-sub">{data?.status_counts?.rejected}</p>
                  </div>
                </div>
              </div>
            </div>
