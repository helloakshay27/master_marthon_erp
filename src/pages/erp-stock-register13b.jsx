  ...
  <div className="card mx-3 mt-3 collapsed-card">
    ...
    <div className="tbl-container m-3 px-1  mt-3">
      <table className="w-100">
        <thead>
          <tr>
            <th className="mor-th">Sr. No.</th>
            <th className="mor-th">Material / Asset</th>
            <th className="mor-th">Material Type</th>
            <th className="mor-th">Material Sub-type</th>
            <th className="mor-th">Material</th>
            <th className="mor-th">Description</th>
            <th className="mor-th">Specification</th>
            <th className="mor-th">Stock Type</th>
            <th className="mor-th">Last Received On</th>
            <th className="mor-th">Total Received</th>
            <th className="mor-th">Total Issued</th>
            <th className="mor-th">
              Stock As on <dd-mm-yy></dd-mm-yy>
            </th>
            <th className="mor-th">Deadstock Qty</th>
            <th className="mor-th">Theft / Missing</th>
            <th className="mor-th">UOM</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="mor-td">1</td>
            <td className="mor-td">MTO 1</td>
            <td className="mor-td">MOR/MAR/MAX/ 101/02/2024</td>
            <td className="mor-td">Neo Valley</td>
            <td className="mor-td">Neo Valley- Building</td>
            <td className="mor-td">Store 3</td>
            <td className="mor-td">STR 1</td>
            <td className="mor-td">Plain IVORY Tiles 300 x 300</td>
            <td className="mor-td">Nos</td>
            <td className="mor-td">40</td>
            <td className="mor-td">40</td>
            <td className="mor-td">Received for Creation</td>
            <td className="mor-td"> shh</td>
            <td className="mor-td"> shh</td>
            <td className="mor-td"> shh</td>
          </tr>
          <tr>
