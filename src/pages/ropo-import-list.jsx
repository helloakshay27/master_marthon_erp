...
const RopoMappingList = () => {
    ...
    // ...existing code...
    {
      ...
      renderCell: (params) => (
        <div
          ...
          onClick={() =>
            navigate(`/ropo-import-details/${params.row.id}?token=${token}`)
          }
        >
          {params.value}
        </div>
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Build base URL
        let url = `${baseURL}purchase_orders.json?q[po_type_eq]=import&page=${currentPage}&per_page=${pageSize}&token=${token}`;
            ...
            <div className="d-flex mt-3 align-items-end px-3">
              ...
              <div className="col-md-6 d-flex justify-content-end align-items-center gap-2  mt-4">
                ...
                <button
                  ...
                  onClick={() => navigate(`/ropo-import-create?token=${token}`)}
                >
                  <span> + Add</span>
                </button>
              </div>
