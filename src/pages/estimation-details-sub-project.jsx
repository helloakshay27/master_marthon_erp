                        ...
                        <CollapsibleCard title="Sub-Project Details">
                            ...
                            <div className="card-body mt-0 pt-0">
                                <div className="row align-items-center">
                                    {[
                                        { label: "RERA Area", placeholder: "", value: subProjectDetails?.rera_area || '' },
                                        { label: "Construction Area", placeholder: "", className: "", value: subProjectDetails?.construction_area || '' },
                                        { label: "Saleable Area Sq.ft.", placeholder: "", value: subProjectDetails?.saleble_area || '' },
                                        { label: "Material Total", placeholder: "", value: subProjectDetails?.material_total || '' },
                                        { label: "Project Budget", placeholder: "", value: subProjectDetails?.project_budget || '' },
                                        { label: "M+L Budget Sq.ft", placeholder: "", className: "mt-2", value: subProjectDetails?.material_labour_budget || '' },
                                        { label: "Budget Type", placeholder: "", className: "mt-2", value: "" },
                                        { label: "Labour Total", placeholder: "", value: subProjectDetails?.labour_total || '' },
                                    ].map((field, index) => (
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input disabled class="form-control" type="number" placeholder="" fdprocessedid="pi363i" value='INR 250000000.00' />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div className="tbl-container mt-1">
                                    <table className="" style={{ width: "max-content", maxHeight: "max-content", height: "auto" }}>
                                        ...
                                        <tbody>
                                            ...
                                            {subProjectDetails && subProjectDetails.categories && subProjectDetails.categories.map((category, index) => (
