    ...
    <>
      <div className="website-content overflow-auto">
        <div className="module-data-section p-4">
          ...
          <h5 className="mt-4">Bill Entry List</h5>
            ...
            <div className="container-fluid">
              <div className="row separteinto6 justify-content-center">
                ...
                <div className="col-md-2 text-center">
                  ...
                  >
                    <h4 className="content-box-title">Online Bills</h4>
                ...
                <div className="col-md-2 text-center">
                  ...
                  >
                    <h4 className="content-box-title">Offline Bills</h4>
                    <p className="content-box-sub">2</p>
                  </div>
                </div>
              </div>
            ...
            <div className="card mt-3 pb-4">
              <div className="card-body">
                <div className="row my-4 align-items-end">
                  ...
                  <a
                    href="../erp_security/Bill_Entry_List_Sub-Page(Create).html"
