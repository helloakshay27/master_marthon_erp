    ...
    const fetchProjectDetails = async () => {
      try {
        ...
        data.categories?.forEach((category) => {
          calculateBudget(category); // Calculate the budget totals
          calculateOrderValues(category); // Calculate the order values
        });
              ...
              <div className="card-body mt-0 pt-0">
                <div className="row align-items-center">
                  {[
                    {
                      label: "RERA Area",
                      value: projectDetails?.rera_area || "",
                    },
                    {
                      label: "Construction Area",
                      placeholder: "",
                      className: "",
                      value: projectDetails?.construction_area || "",
                    },
                    {
                      label: "Saleable Area Sq.ft.",
                      placeholder: "",
                      value: projectDetails?.saleble_area || "",
                    },
                    {
                      label: "Material Total",
                      placeholder: "",
                      value: projectDetails?.material_total || "",
                    },
                    {
                      label: "Project Budget",
                      placeholder: "",
                      value: projectDetails?.project_budget || "",
                    },
                    {
                      label: "M+L Budget Sq.ft",
                      placeholder: "",
                      className: "mt-2",
                      value: projectDetails?.material_labour_budget || "",
                    },
                    {
                      label: "Budget Type",
                      placeholder: "",
                    ...
                    }, //not given in api
                    {
                      label: "Labour Total",
                      placeholder: "",
                      value: projectDetails?.labour_total || "",
                    },
                  ].map((field, index) => (
                    <div
